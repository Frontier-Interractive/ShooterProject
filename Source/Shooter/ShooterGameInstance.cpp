...
bool UShooterGameInstance::JoinSession(TSharedPtr<const FUniqueNetId> UserId, FName SessionName,
...
void UShooterGameInstance::HostOnlineSession()
{
...
void UShooterGameInstance::FindOnlineSessions()
{
...
void UShooterGameInstance::JoinOnlineSession()
{
	ULocalPlayer* const Player = GetFirstGamePlayer();
...
void UShooterGameInstance::DestroyOnlineSession()
{
	IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get();
	if (OnlineSub)
	{
